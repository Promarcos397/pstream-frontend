    ...
    return (
        <div className={`absolute inset-x-0 bottom-0 z-50 bg-gradient-to-t from-black via-black/80 to-transparent px-8 pb-8 pt-20 transition-opacity duration-300 ${showUI ? 'opacity-100 pointer-events-auto' : 'opacity-0 pointer-events-none'}`}>
            ...
            <div className="relative flex items-center justify-between">
                ...
                {/* Centered Title */}
                <div className="absolute left-1/2 transform -translate-x-1/2 z-0 pointer-events-none text-center w-full flex justify-center">
                    <span className="text-2xl text-white select-none whitespace-nowrap overflow-hidden text-ellipsis max-w-[50vw] md:max-w-[60vw] lg:max-w-[70vw] block">
                        {title}
                    </span>
                </div>
                ...
                <div className="flex items-center space-x-6 z-10">
                    {onNextEpisode && showNextEp && (
                        ...
                        >
                            <SkipForwardIcon size={48} weight="bold" />
                        </button>
                    )}
                    ...
                    {onShareClick && (
                        <button
                            ...
                            className="text-gray-300 hover:text-white transition transform hover:scale-110 active:scale-90"
                            title="Share Link"
                        >
                            <ShareNetworkIcon size={48} weight="bold" />
                        </button>
                    )}
